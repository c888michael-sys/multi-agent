...
- [~] **Artifacts and previews.** The Phase 1 backend now extracts structured/legacy file blocks after a completed chat response and provides project-bound, expiring proposals with lazy diffs, CSRF-protected multi-file apply, conflict checks and rollback. The dedicated grouped review UI and sandboxed preview remain next. Specification: [`docs/specs/2026-07-14-web-artifact-workflow.md`](docs/specs/2026-07-14-web-artifact-workflow.md).
