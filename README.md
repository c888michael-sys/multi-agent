...
- [ ] **Artifacts and previews.** Add a review-first, multi-file artifact workflow so one response can create/update a complete static website under the selected project, with batch validation, explicit approval, conflict protection and a sandboxed preview. Implementation-ready specification: [`docs/specs/2026-07-14-web-artifact-workflow.md`](docs/specs/2026-07-14-web-artifact-workflow.md).
